...
Then by chance I stumbled across the video [Is It Time to Rewrite the Operating Systme in Rust?](https://youtu.be/HgtRAbE1nBM), featuring Bryan Cantrill. I'm a sucker for computing history and this video just had everything to engage my attention: an entertaining speaker, history lessons on systems programming, funny anecdotes and, not least, the intriguing promise of this new programming languages called Rust.
